...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        pm2_mask = v2['desc'] == '2'
        v2_pm2_resolved = legacy_pm2 - v2_pm2
        v2_wms_ai = int((v2['VerifiedAI'] == 'wmsAI').sum()) if 'VerifiedAI' in v2.columns else 0
        ...
        self.stdout.write(f'plus_minus_2_resolved_by_v2: {v2_pm2_resolved}')
        self.stdout.write(f'wmsAI: {v2_wms_ai}')
